...
namespace AnimationFrameConstants
{
	namespace FrameDimensions
	{
	...
	namespace FrameSpeeds
	{
		...
		static constexpr float sittingFrameSpeedSlow{ 1.5f };
		static constexpr float sittingFrameSpeedFast{ 1.f };

		static constexpr float PunchingSpeedSlow{ .25f };
		static constexpr float PunchingSpeedFast{ .2f };
	}

	namespace AnimationLengths
	{
